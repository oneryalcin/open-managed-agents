...
function AgentsList({ agents, openAgent, onCreate, dataState = 'loaded' }) {
...
function FilesView({ dataState = 'loaded' }) {
  ...
  return (
    <div className="main-scroll scroll fade-in">
      <PageHead title="Files" sub="Workspace uploads and session-scoped output files." action="Upload file" />
      <div className="toolbar">
      ...
      {loading ? <SkeletonTable rows={5} cols={['grow', 90, 80, 70, 110]} />
       ...
       : empty ? <EmptyState icon="folder" title="No files here"
            ...
            actionLabel="Upload file" onAction={() => {}} />
       : <>
      <div className="panel">
        <div className="thead">
