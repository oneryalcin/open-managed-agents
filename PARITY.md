...
1. **Agent update + versioning** *(implemented in PR #186; review pending; probe 67; plan 0133)* — `POST /v1/agents/{id}`
   ...
   revisions and exact-version runtime pinning; final review remains before the
   item is marked done. Implementation plan: [`docs/plans/0133-cma-agent-update-versioning.md`](docs/plans/0133-cma-agent-update-versioning.md).
