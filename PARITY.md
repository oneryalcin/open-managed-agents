...
`glob` (DONE 2026-07-13) → pagination semantics (DONE 2026-07-13) → agent update/versioning (DONE 2026-07-14) → provider-owned CMA `grep` (DONE 2026-07-14) → usable
...
- [x] **Provider-owned CMA `grep` runtime** *(DONE 2026-07-14; plan 0134; probes 68/68b/68c)*
