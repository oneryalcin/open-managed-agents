...
import {
  peekForClientHello,
  terminateAndForward,
} from './tls-terminate-proxy.ts'
import type { ResolvedParentProxy } from './parent-proxy.ts'
import {
  ...
  server.on('connect', async (req, socket, head) => {
    ...
    try {
      ...
      if (
        ...
        head = peeked.head as typeof head // OMA: @types/node buffer-variance skew
